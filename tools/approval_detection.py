...
DANGEROUS_PATTERNS = [
    ...
    # Both lookaheads search the whole suffix: if they succeed anywhere, they succeed at offset 0.
    # Anchor there so search() cannot rescan every suffix on a benign command (quadratic work).
